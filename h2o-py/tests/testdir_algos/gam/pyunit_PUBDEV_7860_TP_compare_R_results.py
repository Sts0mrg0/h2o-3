...
#    train = h2o.import_file(pyunit_utils.locate("smalldata/glm_test/multinomial_10_classes_10_cols_10000_Rows_train.csv"))
    ...
    dataBinomial = h2o.import_file("/Users/wendycwong/temp/synthetic_20Cols_binomial_20KRows.csv")
    ...
    dataGaussian = h2o.import_file("/Users/wendycwong/temp/synthetic_20Cols_gaussian_20KRows.csv")
